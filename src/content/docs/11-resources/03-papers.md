...
:::tip[与其他章节的关联]
- Attention Is All You Need → [ch01 LLM 基础](/01-llm-fundamentals/01-transformer/)
- ReAct / Reflexion / Tree of Thoughts → [ch02 Agent 设计模式](/02-agent-patterns/01-what-is-agent/)
- Toolformer / Gorilla → [ch05 Tool Use](/03-tool-use/01-function-calling/)
