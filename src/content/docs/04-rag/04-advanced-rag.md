...
<div style="border:2px solid #60a5fa;border-radius:12px;padding:1.2rem 1.5rem;margin:1.5rem 0;">
  <div style="font-size:.9rem;line-height:1.6;">
    <strong>普通检索：</strong><br/>
    问题 "什么是 RAG？" &rarr; embedding &rarr; 检索<br/>
    <span style="opacity:.7;">（问句向量 vs 答案向量，语义空间不同）</span><br/><br/>
    <strong>HyDE：</strong><br/>
    问题 &rarr; LLM 生成假设答案 &rarr; "RAG 是一种将检索与生成结合的技术..." &rarr; embedding &rarr; 检索<br/>
    <span style="opacity:.7;">（答案向量 vs 答案向量，语义空间一致）</span>
  </div>
</div>
