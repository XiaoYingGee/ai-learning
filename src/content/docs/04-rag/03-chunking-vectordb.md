...
<div style="border:2px solid #60a5fa;border-radius:12px;padding:1.2rem 1.5rem;margin:1.5rem 0;">
  <div style="font-weight:bold;text-align:center;color:#60a5fa;margin-bottom:.8rem;">三种分块策略</div>
  <div style="font-size:.9rem;line-height:1.6;">
    <strong>1. 固定大小分块 (Fixed-size)</strong><br/>
    <code>[500字][500字][500字][500字]</code><br/>
    简单但可能在句子中间截断<br/><br/>
    <strong>2. 语义分块 (Semantic)</strong><br/>
    <code>[段落1][──段落2──][3][──段落4─]</code><br/>
    按语义边界切分，长度不等<br/><br/>
    <strong>3. 递归分块 (Recursive)</strong><br/>
    先按 <code>\n\n</code> 分 &rarr; 太长则按 <code>\n</code> 分 &rarr; 仍太长按句号分<br/>
    <code>[自然段][自然段][句子][自然段]</code><br/>
