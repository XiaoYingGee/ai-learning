...
<div style="border:2px solid #888;border-radius:12px;padding:1rem;margin:1.5rem 0;">
  ...
  <div style="border:2px solid #f97316;border-radius:8px;padding:1rem;margin:.5rem;">
    <div style="font-weight:bold;color:#f97316;margin-bottom:.5rem;">Sandbox（沙箱）</div>
...
<div style="border-left:4px solid #60a5fa;padding:.8rem 1.2rem;margin:.8rem 0;background:rgba(255,255,255,0.03);border-radius:0 8px 8px 0;">
  <details>
    <summary style="font-weight:bold;color:#60a5fa;cursor:pointer;">自测题 1：为什么 LLM 需要代码执行能力，它自己不能计算吗？</summary>
...
<div style="border-left:4px solid #60a5fa;padding:.8rem 1.2rem;margin:.8rem 0;background:rgba(255,255,255,0.03);border-radius:0 8px 8px 0;">
  <details>
    <summary style="font-weight:bold;color:#60a5fa;cursor:pointer;">自测题 2：沙箱需要限制哪些资源？为什么？</summary>
    <div style="margin-top:.8rem;font-size:.9rem;">
...
<div style="border-left:4px solid #60a5fa;padding:.8rem 1.2rem;margin:.8rem 0;background:rgba(255,255,255,0.03);border-radius:0 8px 8px 0;">
  <details>
    <summary style="font-weight:bold;color:#60a5fa;cursor:pointer;">自测题 3：E2B 和 Docker 自建沙箱各有什么优缺点？</summary>
    <div style="margin-top:.8rem;font-size:.9rem;">
