...
:::tip[与其他章节的关联]
- **ch02 设计模式**：ReAct、Plan-and-Execute 等模式是系统设计的基础选型，详见 [Agent 设计模式](/02-agent-patterns/01-what-is-agent/)
- **ch04 RAG**：大多数企业 Agent 系统都包含 RAG 组件，详见 [RAG 深入](/04-rag/)
- **ch07 生产化**：可观测性、成本控制等追问方向的详细实现，详见 [生产化章节](/07-production/)
:::
